                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group row mb-0 offset-md-1">
                          ...
                          <div class="form-check form-check-inline">
                              <input name="autoriza" class="form-check-input" type="checkbox" id="al" value="al"  onclick ="aut();aluno()">
                          ...
                          <div class="form-check form-check-inline">
                              <input name="autoriza" class="form-check-input" type="checkbox" id="fe" value="fe" onclick="aut();funcionario()">
                      ...
                      <div class="form-check form-check-inline">
                          <input name="autoriza" class="form-check-input" type="checkbox" id="ra" value="ra" onclick="aut();resp_aluno()">
...
<!--ALUNOS-->
<div id="dados_alunos">
<h4>Dados Adicionais - Alunos EMEI ou Escola Y-Juca Pirama</h4>
    <div class="row">
        <div class="col-md-12">
            <div class="form-group">
    ...
    <div class="row">
        <div class="col-md-6">
            <div class="form-group">
                <label for="dt_nascimento">Dt. Nascimento DO ALUNO <i class="fas fa-comment" data-toggle="tooltip" data-placement="right" title="Digite a data de nascimento do ALUNO"></i></label>
                <input type="date" class="form-control" id="dt_nascimento" name="dt_nascimento">
            </div>
        </div>
        <div class="col-md-6">
            <div class="form-group">
                <label for="serie">Série <i class="fas fa-comment" data-toggle="tooltip" data-placement="right" title="Selecione a série do ALUNO"></i></label>
