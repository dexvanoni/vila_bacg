            ...
            <div class="row">
                <div class="col-12">
                    <div class="form-group">
                        <label for="local">Selecione a Área de Lazer</label>
                        <select class="form-control" id="local" name="local" required>
                                <option value="c">Clique aqui...</option>
                                <option value="ALOF">ALOF</option>
                                <option value="ALSS">ALSS</option>
                                <option value="ALCTS">ALCTS</option>
                        </select>
                    </div> 
                </div>
            </div>
...
<input type="hidden" name="autorizacao" value="so">
