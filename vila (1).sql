...
--
-- Host: 127.0.0.1:3306
-- Tempo de geração: 18-Jan-2023 às 19:29
...
CREATE TABLE IF NOT EXISTS `locais` (
  `id` int UNSIGNED NOT NULL AUTO_INCREMENT,
  `onesignal_id` varchar(191) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `local` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
  `tipo` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
  `responsavel` varchar(191) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `status` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
  `arquivo` varchar(191) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`)
...
INSERT INTO `locais` (`id`, `onesignal_id`, `local`, `tipo`, `responsavel`, `status`, `arquivo`, `created_at`, `updated_at`) VALUES
(1, NULL, 'FOX2018', 'PNR', 'DENIS VIEIRA VANONI', 'PNR OCUPADO', NULL, NULL, NULL);
...
(8, '2023_01_18_143020_create_locais_table', 7);
...
CREATE TABLE IF NOT EXISTS `users` (
  ...
  `ramal` text COLLATE utf8mb4_unicode_ci,
  `email` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
...
INSERT INTO `users` (`id`, `name`, `telefone`, `ramal`, `email`, `email_verified_at`, `password`, `remember_token`, `autorizacao`, `local`, `created_at`, `updated_at`) VALUES
(3, 'DENIS VIEIRA VANONI', '67 991224547', '3128', 'vanonidvv@fab.mil.br', NULL, '$2y$10$pow3aCu9bR02X3rCkBD7HunJZe4BYMuSUIx8W4gYcu6js1C0BOhAu', 'Y7DE53OSxSDuOfJmsMOkrtIRgqQ8BxoZaz6SXB42qfPDs1qdd8uYMI8hyWvP', 'ad', 'PNR - F.2018', '2023-01-06 00:06:45', '2023-01-06 00:08:11'),
(16, 'PVO - Portão Vila dos Oficiais', NULL, NULL, 'pvo_sisvila@gmail.com', NULL, '$2y$10$wRn5p4E.EIIBoPz.Uj3dzuncFPnXMAoedUhKeaPRMOj9kBdMXzKh2', 'zhKzPiBxoROU6mHEUqISkUV0fqSlIEeaMtQf6Q6Ruw3QKrWS1zUC8ysgK023', 'po', 'PVO', '2023-01-15 01:22:30', '2023-01-15 01:22:30'),
(13, 'Fabiana Bezerra de Souza Vanoni', '67 992014825', NULL, 'fabianartv@gmail.com', NULL, '$2y$10$iQpj4BEWcuDlB7Q.w0q9aO9kKOZJ08/uvqH8zJ2xm5//985/2lyAW', 'K5jQ21s9ln3yhLPK2tRUgsVLXWT1725Pbsib4puxzkKRVj9TZISAI4zw9Gr9', 'de,sd', 'PNR - F.2018', '2023-01-11 23:51:45', '2023-01-11 23:51:45'),
(15, 'Sgt Walter', NULL, NULL, 'walter@gmail.com', NULL, '$2y$10$ev5OnVTwhOtt4TOJ6cKtHeIcL5mYQGERdHCEri73zziFL5Ot7GvVm', NULL, 'ad', 'PNR - F.2010', '2023-01-14 15:34:41', '2023-01-14 15:34:41'),
(17, 'PVSS - Portão Vila dos Suboficiais e Sargentos', NULL, NULL, 'pvss_sisvila@gmail.com', NULL, '$2y$10$IkvAv6HjxhJ/Taw7NKRW6OJeXi.1vX7NoakG56h22TvIBsJvPoaK2', NULL, 'po', 'PVSS', '2023-01-15 01:24:17', '2023-01-15 01:24:17');
COMMIT;
